...
def agregar_evento():
    ...
    try:
        ...
        messagebox.showwarning("Error", "Formato de fecha incorrecto. Use dd/mm/aaaa.")
        return
...
fecha_entry = tk.Entry(frame_entrada, bg="#fafad2", fg="#000000")
...
# Etiquetas y campos de entrada
tk.Label(frame_entrada, text="Fecha (dd/mm/aaaa):").grid(row=0, column=0, padx=10, pady=5)
fecha_entry = tk.Entry(frame_entrada)
fecha_entry.grid(row=0, column=1, padx=10, pady=5)

tk.Label(frame_entrada, text="Hora:").grid(row=1, column=0, padx=10, pady=5)
